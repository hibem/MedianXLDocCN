...
//大段文字
    ...
    .replace(/The Flamen staves and Marrow staves are an exception to this rule, both the ending staves being SSU./g,
             '出了珠宝以外，所有神圣暗金装备都有2-3种的变体，下表中从左到右分别被称为SU，SSU，SSSU。<br>104+地图掉落SU，117+地图掉落SSU，130+地图掉落SSSU。<br>德鲁伊和死灵法师的专属双手杖是一个例外，它们的第二、三个变体都属于SSU，也就是没有SSSU版本。')
...
//Boss战
    ...
    //技能
    .replace(/ to Scattershot/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 裂帛击 Scattershot<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/7/72/Scattershot.gif/revision/latest?cb=20180317194321"></li><li>弓弩技能-范围打击-40%武器伤害</li></ul></span>')
    .replace(/ to Wolf Stance/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 狼姿态 Wolf Stance<span class="caret"></span></span><ul class="dropdown-menu"><li>姿态技能：增加攻击力，击回，战斗速度（除了施法速度）</li></ul></span>')
    ...
    .replace(/ Bloodlust/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Bloodlust 嗜血）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/9/97/Bloodlust.gif/revision/latest?cb=20171030123459"></li><li>Buff - 增强你的所有伤害</li></ul></span>')
    .replace(/ Banish/g, 'Banish（放逐，诅咒 -减敌最大生命）')
    .replace(/ Frog Prince/g, 'Frog Prince（青蛙王子 -施放冰环）')
    .replace(/ to Plague/g, 'Plague（疫病）')
    .replace(/ Shower of Rocks/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Shower of Rocks 落石）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/c/c2/Shower_of_Rocks.gif/revision/latest?cb=20180123022550"></li><li>从天而降的岩石伤害并降低敌人的防御和攻速</li></ul></span>')
    .replace(/ Spike Nova/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Spike Nova 尖刺新星）<span class="caret"></span></span><ul class="dropdown-menu"><li>射出一支飞行中不断施放尖刺新星的标枪</li></ul></span>')
    ...
    .replace(/ Glacial Nova/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Glacial Nova 冰川新星）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/7/77/Glacial_Nova.gif/revision/latest?cb=20171012171406"></li><li>冰伤 - 施放一个超大范围冰封2秒的寒冰新星</li></ul></span>')
    ...
    .replace(/ Shatterblade/g, '（Shatterblade 裂刀）')
    .replace(/ Spellbind/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Spellbind 法术缠绕）<span class="caret"></span></span><ul class="dropdown-menu"><li>诅咒 - 扔出使敌人石化的蛇群 - 减速度/物抗/攻击/防御</li></ul></span>')
    .replace(/ Punisher/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Punisher 天谴）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/e/e7/Punisher.gif/revision/latest?cb=20171015153834"></li><li>毒伤 - 施放移动缓慢但致命的金属刺球</li></ul></span>')
    .replace(/ Charged Strike/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Charged Strike 充能一击） <span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/9/94/Charged_Strike.gif/revision/latest?cb=20190218213456"></li><li>武器伤害 - 近战攻击时施放强力的电火花</li></ul></span>')
    .replace(/ Squall Wave/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Squall Wave 飓风波）<span class="caret"></span></span><ul class="dropdown-menu"><li>射出多个可以造成巨大冲击波的箭矢</li></ul></span>')
    .replace(/ Blade Spirits/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Blade Spirits 刀刃之灵）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/3/3b/Blade_Spirit.png/revision/latest?cb=20180206023602"></li><li>召唤刀刃之灵 - 该召唤物受到法师所有元素系被动的加成</li></ul></span>')
    .replace(/ Pentagram/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Pentagram 五角星）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/7/73/Pentagram.gif/revision/latest?cb=20171015150140"></li><li>火伤 - 从脚底扩散的火焰五角星</li></ul></span>')
    .replace(/ Shuriken Flurry/g, 'Shuriken Flurry（手里剑乱舞）')
    .replace(/50 Blizzard/g, '50 （Blizzard 暴风雪）')
    ...
    .replace(/ Amatoxin/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Amatoxin 菇毒）<span class="caret"></span></span><ul class="dropdown-menu"><li>被动 - 武器增加毒素伤害</li></ul></span>')
    ...
    .replace(/ Supernova/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Supernova 超新星）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/b/b9/Supernova.gif/revision/latest?cb=20180217022254"></li><li>电伤 - 施放一个超大范围多次打击的闪电新星</li></ul></span>')
    ...
    .replace(/ Cataclysm/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Cataclysm 浩劫）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/2/24/Cataclysm.gif/revision/latest?cb=20180402183704"></li><li>火伤 - 施放一个超大范围的火弹新星</li></ul></span>')
    ...
    .replace(/ Earthquake/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Earthquake 地震）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/a/ad/Earthquake.gif/revision/latest?cb=20180123021229"></li><li>近战攻击时施放一个造成80%武器伤害的冲击波</li></ul></span>')
    .replace(/ Time Wave/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Time Wave 延时波）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/6/6d/Time_Wave.gif/revision/latest?cb=20171016160117"></li><li>延时打击群体版 - 附近的每个敌人都会受到延时打击</li></ul></span>')
    .replace(/ Timefield/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Timefield 时间力场）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/3/36/Timefield.gif/revision/latest?cb=20180516195253"></li><li>诅咒 - 降低敌人 61% 的速度</li></ul></span>')
    .replace(/ Time Strike/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Time Strike 延时打击）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/a/a5/Time_Strike.gif/revision/latest?cb=20180330002255"></li><li>近战攻击随后是第二次延迟打击</li></ul></span>')
    .replace(/ Veil King Plague Grasp/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Veil King Plague Grasp 帷幕之王的瘟疫之握）<span class="caret"></span></span><ul class="dropdown-menu"><li>造成小范围的AOE毒伤</li></ul></span>')
    .replace(/ Stormlord/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Stormlord 风暴领主）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/0/04/Wearing_Vasily%27s_Following.gif/revision/latest/scale-to-width-down/185?cb=20180722001826"></li><li>被动 - 增加你的四围（力敏体精）</li></ul></span>')
    .replace(/ Rotting Flesh/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Rotting Flesh 腐烂血肉）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/3/3c/Rotting_Flesh.gif/revision/latest?cb=20180128005657"></li><li>施放一个四射毒素的腐烂之云</li></ul></span>')
    .replace(/ Pagan Rites/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Pagan Rites 异教徒仪式）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/5/5d/Pagan_Rites.gif/revision/latest?cb=20180123042032"></li><li>净化尸体并立即恢复一部分生命值</li></ul></span>')
    .replace(/ Ancients' Hand/g, '<span class="dropup"><span class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">（Ancients\' Hand 先祖之手）<span class="caret"></span></span><ul class="dropdown-menu"><li><img src="https://vignette.wikia.nocookie.net/median-xl/images/2/23/Ancients%27_Hand.gif/revision/latest?cb=20180328222228"></li><li>攻击时施放先祖之手造成多段的火焰伤害</li></ul></span>')



    //怪物
    .replace(/ Void Archon/g, ' 虚空执政官（Void Archon）')
    .replace(/ Flesh Clan/g, ' 羊头人战士（Flesh Clan）')
    .replace(/ Necrobot/g, ' 死灵机器人（Necrobot）')
    .replace(/ Venom Fiend/g, ' 毒魔（Venom Fiend）')
    .replace(/ Condemned/g, ' 火人（Condemned）')
    .replace(/ Moon Knight/g, ' 月亮骑士（Moon Knight）')
    .replace(/ Banshee/g, ' 女妖（Banshee）')
    .replace(/ Acid Beast/g, ' 酸液兽（Acid Beast）')
    .replace(/ Umbaru Spirit/g, ' 部族巫师（Umbaru Spirit）')
    .replace(/ Horror Arche/g, ' 恐怖射手（Horror Arche）')
    .replace(/ Burning Dead Archer/g, ' 燃烧射手（Burning Dead Archer）')
    .replace(/ Bone Archer/g, ' 骷髅射手（Bone Archer）')
    .replace(/ Dark Templar/g, ' 黑暗圣堂（Dark Templar）')
    .replace(/ Infernal Lord/g, ' 炼狱领主（Infernal Lord）')
    .replace(/ Zombie/g, ' 僵尸（Zombie）')
...
//其他
  ...
  //装备属性词条
    ...
    .replace(/Poison Resist /g, '毒素抗性（pr）')
...
//菜单及基础单词
    ...
    .replace(/>Items /g, '>( √ ) 物品  ')
    .replace(/>Runewords/g, '>( √ ) 神符之语')
    .replace(/Patch Notes/g, '( × 未翻译，√ 已完成， … 进行中 )')
    .replace(/>Characters </g, '>( × ) 角色资料 <')
