...
//菜单及基础单词
    ...
    .replace(/>Paladin Clubs</g, '>圣骑士专用棍棒 Paladin Clubs<')
    .replace(/>Paladin Hammers</g, '>圣骑士专用锤<')
    .replace(/>Paladin Spears</g, '>圣骑士专用矛<')
    ...
    .replace(/Sorceress Crystal Swords/g, '法师专用水晶剑')
    ...
    .replace(/>Body Armor</g, '>盔甲 Body Armor<')
    .replace(/>Circlets</g, '>头环 Circlets<')
    .replace(/>Shields</g, '>盾牌<')
    .replace(/>Belts</g, '>腰带 Belts<')
    .replace(/b>Boots</g, 'b style="color:#fff;">鞋子 Boots<')
    .replace(/>Helms</g, '>头盔 Helms<')
    .replace(/>Gloves</g, '>手套 Gloves<')
    .replace(/Crystal Swords/g, '水晶剑 Crystal Swords')
    .replace(/Two-Handed Axes/g, '双手斧 Two-Handed Axes')
