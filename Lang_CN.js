...
//Boss战
    ...
    //技能
    .replace(/ to Scattershot/g, 'hb1 裂帛击 hb2"https://vignette.wikia.nocookie.net/median-xl/images/7/72/Scattershot.gif/revision/latest?cb=20180317194321"hb3Scattershot<br>弓弩技能-范围打击-40%武器伤害hb4')
    .replace(/ to Wolf Stance/g, 'hb1 狼姿态 hb5Wolf Stance<br>姿态技能：增加攻击力，击回，战斗速度（除了施法速度）hb4')
    ...
    .replace(/ Punisher/g, 'hb1 天谴hb2"https://vignette.wikia.nocookie.net/median-xl/images/e/e7/Punisher.gif/revision/latest?cb=20171015153834"hb3（Punisher）毒伤 - 施放移动缓慢但致命的金属刺球hb4')
    ...
    .replace(/ Jinn/g, 'hb1 魔灵hb2"https://vignette.wikia.nocookie.net/median-xl/images/d/d7/Jinn.png/revision/latest?cb=20180131204338"hb3（Jinn）<br>召唤 - 拥有地狱火光环的魔灵，光环降低敌人的火抗，并提升队友的最大火抗hb4')
    ...
    //怪物
    .replace(/ Fallen Shaman/g, ' 沉沦魔萨满（Fallen Shaman）')
...
//格式化
   ...
   // .replace(/ Nova/g, 'hb1 闪电新星hb2"https://vignette.wikia.nocookie.net/diablo/images/6/65/D2nova.jpg/revision/latest/scale-to-width-down/320?cb=20150728184705"hb3（Nova）<br>原版法术 - 向外扩散并造成闪电伤害的中型圆环hb4')
    ...
    .replace(/hb2/g, ' <span class="glyphicon glyphicon-picture" aria-hidden="true"></span></span><ul class="dropdown-menu"><li><img src=')
    .replace(/hb3/g, '></li><li>')
